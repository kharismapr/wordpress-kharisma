...
export default function Page1() {
    return (
        <div className="min-h-screen bg-[#007cba] text-white">
            {/* Header */}
            <nav className="bg-[#007cba] text-white p-4 flex flex-row">
                ...
                {/* Navigation Links */}
                <ul className="hidden md:flex items-center space-x-6 text-sm font-medium ml-8">
            ...
            <main className="flex flex-col md:flex-row items-center justify-center min-h-[calc(100vh-80px)] p-8">
                ...
                <div className="md:w-1/2 text-center md:text-left space-y-4">
                    <h1 className="text-4xl md:text-5xl font-bold ml-10">Hassle-free WordPress</h1>
                    <p className="text-md md:text-lg ml-10">
                    ...
                    <button
                        ...
                        className="bg-white text-[#007cba] px-6 py-3 rounded-md hover:bg-gray-200 ml-10"
                    >
                        Get started
                    </button>
                </div>
